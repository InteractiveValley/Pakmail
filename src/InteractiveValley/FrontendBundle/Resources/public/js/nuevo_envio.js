...
$(document).on('ready', function () {
    ...
    var $asegurarEnvio = $("#interactivevalley_pakmailbundle_envio_asegurarEnvio");
    var $montoSeguro = $("#interactivevalley_pakmailbundle_envio_montoSeguro");
    var $importeSeguro = $("#interactivevalley_pakmailbundle_envio_importeSeguro");
    ...
    $asegurarEnvio.on('click',function(e){
        if($(this).is(":checked")){
            ...
            $montoSeguro.parent().parent().removeClass('has-warning');
