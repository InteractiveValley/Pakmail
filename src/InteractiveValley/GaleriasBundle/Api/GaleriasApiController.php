...
use InteractiveValley\BackendBundle\Exception\InvalidFormException;
use InteractiveValley\PublicacionesBundle\Entity\Galeria;
use InteractiveValley\PublicacionesBundle\Form\GaleriaType;
use InteractiveValley\PublicacionesBundle\Form\GaleriaLinkVideoType;
...
class GaleriasController extends FOSRestController
{
     ...
     *   output = "InteractiveValley\PublicacionesBundle\Entity\Galeria",
     *   statusCodes = {
     *     200 = "Returned when successful",
     ...
     *   input = "InteractiveValley\PublicacionesBundle\Form\GaleriaType",
     *   statusCodes = {
     *     200 = "Returned when successful",
