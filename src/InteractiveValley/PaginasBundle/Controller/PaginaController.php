...
namespace InteractiveValley\PaginasBundle\Controller;
...
use InteractiveValley\PaginasBundle\Entity\Pagina;
use InteractiveValley\PaginasBundle\Form\PaginaType;
