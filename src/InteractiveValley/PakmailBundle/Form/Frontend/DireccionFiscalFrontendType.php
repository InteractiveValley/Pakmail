...
class DireccionFiscalFrontendType extends AbstractType
{
    ...
    {
        $builder
            ->add('denominacion','text',array('required'=>FALSE,'label'=>'Denominación/Razón Social','attr'=>array('class'=>'form-control')))
            ->add('rfc','text',array('required'=>FALSE,'label'=>'RFC','attr'=>array('class'=>'form-control')))
            ->add('nombreComercial','text',array('required'=>FALSE,'label'=>'Nombre comercial','attr'=>array('class'=>'form-control')))
            ->add('calle','text',array('required'=>FALSE,'label'=>'Calle ','attr'=>array('class'=>'form-control')))
            ->add('numExterior','text',array('required'=>FALSE,'label'=>'Número Exterior ','attr'=>array('class'=>'form-control')))
            ->add('numInterior','text',array('required'=>FALSE,'label'=>'Número Interior ','attr'=>array('class'=>'form-control')))
            ...
            ->add('estado','text',array('required'=>FALSE,'label'=>'Estado o entidad federativa ','attr'=>array('class'=>'form-control')))
            ->add('delegacion','text',array('required'=>FALSE,'label'=>'Municipio o Delegación ','attr'=>array('class'=>'form-control')))
            ->add('poblacion','text',array('required'=>FALSE,'label'=>'Población o Colonia ','attr'=>array('class'=>'form-control')))
            ->add('cp','text',array('required'=>FALSE,'label'=>'Código postal ','attr'=>array('class'=>'form-control')))
            ->add('telefono','text',array('required'=>FALSE,'label'=>'Teléfono ','attr'=>array('class'=>'form-control input-mask-phone')))
            ->add('celular','text',array('required'=>FALSE,'label'=>'Celular ','attr'=>array('class'=>'form-control input-mask-phone')))
            ->add('email','text',array('required'=>FALSE,'label'=>'E-mail ','attr'=>array('class'=>'form-control')))
        ;
    }
