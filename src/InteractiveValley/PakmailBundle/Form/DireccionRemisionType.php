...
class DireccionRemisionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('poblacion','text',array('label'=>'Poblacion','attr'=>array('class'=>'form-control')))
            ...
            ->add('pais','text',array('label'=>'Pais','attr'=>array('class'=>'form-control')))
            ...
            ->add('celular','text',array('label'=>'Celuar','attr'=>array('class'=>'form-control')))
