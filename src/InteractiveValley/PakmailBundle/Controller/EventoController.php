...
use InteractiveValley\PakmailBundle\Entity\Evento;
use InteractiveValley\PakmailBundle\Form\EventoType;
...
class EventoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PakmailBundle:Evento')
                       ->findBy(array(),array('fechaEvento'=>'DESC'));
     ...
     * @Method("POST")
     * @Template("PakmailBundle:Evento:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PakmailBundle:Evento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PakmailBundle:Evento:edit.html.twig")
     */
