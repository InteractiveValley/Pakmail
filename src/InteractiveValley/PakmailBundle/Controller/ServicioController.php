...
use InteractiveValley\PakmailBundle\Entity\Servicio;
use InteractiveValley\PakmailBundle\Form\ServicioType;
...
class ServicioController extends Controller
{
     ...
     * @Method("POST")
     * @Template("PakmailBundle:Servicio:new.html.twig")
     */
    ...
    {
        $entity = new Servicio();
        $max = $this->getDoctrine()->getRepository('PakmailBundle:Servicio')
                    ->getMaxPosicion();
        if (!is_null($max)) {
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PakmailBundle:Servicio')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="servicios_update")
     * @Method("PUT")
     * @Template("PakmailBundle:Servicio:edit.html.twig")
     */
    ...
    public function ordenarRegistrosAction(Request $request) {
        if ($request->isXmlHttpRequest()) {
            ...
            foreach ($registro_order as $order => $id) {
                $registro = $em->getRepository('PakmailBundle:Servicio')->find($id);
