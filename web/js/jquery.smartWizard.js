...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next :     $('<input />').attr("value", "Siguiente").attr("type", "button").addClass("buttonNext btn btn-bg pull-right"),
        previous : $('<input />').attr("value", "Anterior").attr("type", "button").addClass("buttonPrevious btn btn-bg pull-right"),
        finish  :  $('<input />').attr("value", "Generar solicitud").attr("type", "submit").addClass("btn btn-bg btn-danger pull-right")
    };
